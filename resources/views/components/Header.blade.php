...
<nav class="bg-white border-gray-200 dark:bg-blue-950 sticky">
  ...
  <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
      ...
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">KELDEV</span>
  </a>
  <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        <span class="sr-only">Open user menu</span>
        <img class="w-8 h-8 rounded-full" src="{{url('images/michael.jpg')}}" alt="michaelpogi.jpg">
      </button>

      <!-- Dropdown menu -->
      <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 absolute top-12 right-16" id="user-dropdown">
        <div class="px-4 py-3">
          <span class="block text-sm text-gray-900 dark:text-white">Michael Z. Sabino</span>
          <span class="block text-sm  text-gray-500 truncate dark:text-gray-400">michaels6355@gmail.com</span>
        </div>
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-blue-950 dark:border-gray-700">
      <li>
...
<script> // Function to toggle dropdown menu
...
// Event listeners for the dropdown and burger menu buttons
document.addEventListener('DOMContentLoaded', () => {
  const userMenuButton = document.getElementById('user-menu-button');
  const burgerMenuButton = document.querySelector('[data-collapse-toggle="navbar-user"]');
